# Given-Dapp[development]

A simple open source dApp for status.im which allows the donation and distribution of ether amongst charities nominated to participate in the funding pool.
